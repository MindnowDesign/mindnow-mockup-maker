...
export function GoogleSignInButton({
  ...
  return (
    <button
      ...
      disabled={disabled}
      onClick={onClick}
      className="inline-flex h-10 w-full items-center justify-center gap-2 rounded-lg border border-neutral-700 bg-neutral-900/30 px-3 text-sm font-semibold text-neutral-100 transition-colors hover:bg-neutral-800 disabled:pointer-events-none disabled:opacity-50"
    >
      <GoogleIcon />
      {label}
    </button>
