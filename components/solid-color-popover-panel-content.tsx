...
export const solidColorPopoverContentClass =
  "w-[min(100vw-2rem,280px)] border-neutral-700 bg-neutral-900 p-3 shadow-xl ring-1 ring-neutral-700 text-neutral-100";

/** Gradient fill draggable picker only (+20% vs standard popover width). */
export const draggableColorPopoverContentClass =
  "w-[min(100vw-2rem,336px)] border-neutral-700 bg-neutral-900 p-3 shadow-xl ring-1 ring-neutral-700 text-neutral-100";
