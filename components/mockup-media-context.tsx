...
export function MockupMediaProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    frame.canvasDotGridPercent,
    frame.canvasDotGridColorBack,
    frame.canvasDotGridColorFill,
    frame.canvasDotGridShape,
    frame.canvasDotGridSize,
    frame.canvasDotGridGapX,
    frame.canvasDotGridGapY,
    frame.canvasDotGridSizeRange,
    frame.canvasDotGridOpacityRange,
