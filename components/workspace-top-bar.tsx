  ...
  const runPersist = useCallback(async (opts?: { capture?: boolean; force?: boolean }) => {
    ...
    try {
      ...
      const effectsPayload = {
        ...
        ...(canvasDotGridPercent > 0 && {
          dotGridPercent: canvasDotGridPercent,
          dotGrid: {
            colorBack: canvasDotGridColorBack.trim().toUpperCase(),
            colorFill: canvasDotGridColorFill.trim().toUpperCase(),
        ...
        ...(canvasDitherEnabled && {
          dither: {
            enabled: true,
            colorBack: canvasDitherColorBack.trim().toUpperCase(),
            colorFront: canvasDitherColorFront.trim().toUpperCase(),
            colorHighlight: canvasDitherColorHighlight.trim().toUpperCase(),
        ...
        ...(canvasHalftoneEnabled && {
          halftone: {
            enabled: true,
            colorBack: canvasHalftoneColorBack.trim().toUpperCase(),
            colorFront: canvasHalftoneColorFront.trim().toUpperCase(),
